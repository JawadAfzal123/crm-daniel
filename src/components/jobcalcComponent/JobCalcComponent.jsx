...
const JobCalculator = () => {
  ...
  const handleCalculate = () => {
    ...
    // const materialTax = calculateMaterialTax();
    // const caulkingandScrews = calculateCaulkingAndScrews();
    // const woodframeCost = calculateWoodFrameCost(subTotal);
    // const laborCost = calculateLaborCost(subTotal);
    // const commissionAmount = calculateCommissionAmount();
    // const contractTotal = calculateContractTotal();
    // const luxuryCondoPrice = calculateLuxuryCondoPrice(subTotal);
    // const deliveryFee = calculateDeliveryFeeLuxuryCondo(subTotal);
    ...
    // console.log("Material Tax:", materialTax);
    // console.log("Caulking And Screws:", caulkingandScrews);
    // console.log("Wood Frame Cost:", woodframeCost);
    // console.log("Labor Cost:", laborCost);
    // console.log("Commission Amount:", commissionAmount);
    // console.log("Contract Total:", contractTotal);
    // console.log("Luxury Condo Price:", luxuryCondoPrice);
    // console.log("Delivery Fee Luxury Condo:", deliveryFee);
